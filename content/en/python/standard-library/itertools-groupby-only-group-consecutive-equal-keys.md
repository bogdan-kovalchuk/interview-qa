---
id: py-stdlib-0006
title: "Why does `itertools.groupby()` only group consecutive equal keys, and when does the input need to be sorted first?"
description: "Why does `itertools.groupby()` only group consecutive equal keys, and when does the input need to be sorted first?"
track: python
