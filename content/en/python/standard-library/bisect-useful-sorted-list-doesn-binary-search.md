---
id: py-stdlib-0014
title: "When is `bisect` useful for a sorted list, and why doesn't binary search make insertion cheap?"
description: "When is `bisect` useful for a sorted list, and why doesn't binary search make insertion cheap?"
track: python
