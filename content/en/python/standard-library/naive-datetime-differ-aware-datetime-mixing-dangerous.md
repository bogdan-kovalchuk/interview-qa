---
id: py-stdlib-0011
title: "How does a naive `datetime` differ from an aware `datetime`, and why is mixing them dangerous?"
description: "How does a naive `datetime` differ from an aware `datetime`, and why is mixing them dangerous?"
track: python
