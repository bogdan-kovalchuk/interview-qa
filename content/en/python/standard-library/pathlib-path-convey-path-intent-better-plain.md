---
id: py-stdlib-0009
title: "Why does `pathlib.Path` convey path intent better than a plain string?"
description: "Why does `pathlib.Path` convey path intent better than a plain string?"
track: python
