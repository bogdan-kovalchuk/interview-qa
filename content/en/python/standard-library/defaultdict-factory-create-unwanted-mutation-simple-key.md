---
id: py-stdlib-0003
title: "When can a `defaultdict` factory create an unwanted mutation from a simple key read?"
description: "When can a `defaultdict` factory create an unwanted mutation from a simple key read?"
track: python
