---
id: py-stdlib-0013
title: "When is `heapq` preferable to a full sort for top-k or a priority queue?"
description: "When is `heapq` preferable to a full sort for top-k or a priority queue?"
track: python
