---
id: py-itergen-0012
title: "How do `throw()` and `close()` affect control flow inside a suspended generator?"
description: "How do `throw()` and `close()` affect control flow inside a suspended generator?"
track: python
