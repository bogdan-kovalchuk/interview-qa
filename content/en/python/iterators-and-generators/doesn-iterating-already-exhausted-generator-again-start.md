---
id: py-itergen-0013
title: "Why doesn't iterating an already exhausted generator again start the computation over?"
description: "Why doesn't iterating an already exhausted generator again start the computation over?"
track: python
