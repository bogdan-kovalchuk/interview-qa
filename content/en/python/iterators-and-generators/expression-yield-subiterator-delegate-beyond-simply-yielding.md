---
id: py-itergen-0009
title: "What does the expression `yield from subiterator` delegate beyond simply re-yielding each value?"
description: "What does the expression `yield from subiterator` delegate beyond simply re-yielding each value?"
track: python
