---
id: py-itergen-0014
title: "What problem does passing a single iterator to two consumers that read it in turn create?"
description: "What problem does passing a single iterator to two consumers that read it in turn create?"
track: python
