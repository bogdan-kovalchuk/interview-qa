---
id: py-prac-0002
title: "What does `events = []; enabled = False; enabled and events.append(\"run\"); print(events)` print, and why didn't the side effect happen?"
description: "What does `events = []; enabled = False; enabled and events.append(\"run\"); print(events)` print, and why didn't the side effect happen?"
track: python
