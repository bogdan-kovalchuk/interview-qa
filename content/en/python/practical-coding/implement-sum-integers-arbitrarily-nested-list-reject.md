...
description: "Implement the sum of integers in an arbitrarily nested list: reject `bool`, raise `TypeError` for other types, and `ValueError` for a cycle in the lists."
track: python
