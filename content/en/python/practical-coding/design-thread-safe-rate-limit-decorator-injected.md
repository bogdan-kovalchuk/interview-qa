---
id: py-prac-0018
title: "Design a thread-safe rate-limit decorator with an injected monotonic clock: up to X calls per rolling T seconds, raising an explicit exception on excess."
description: "Design a thread-safe rate-limit decorator with an injected monotonic clock: up to X calls per rolling T seconds, raising an explicit exception on excess."
track: python
