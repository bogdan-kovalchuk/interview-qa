---
id: py-decor-0012
title: "What happens to the decorated name if the decorator returns `None` instead of a callable?"
description: "What happens to the decorated name if the decorator returns `None` instead of a callable?"
track: python
section: decorators
level: middle
type: pitfall
