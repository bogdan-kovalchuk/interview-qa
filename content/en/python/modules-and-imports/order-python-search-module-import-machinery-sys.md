---
id: py-modimp-0005
title: "In what order does Python search for a module through the import machinery and `sys.path`?"
description: "In what order does Python search for a module through the import machinery and `sys.path`?"
track: python
