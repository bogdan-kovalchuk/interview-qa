---
id: py-modimp-0013
title: "Why doesn't `importlib.reload(module)` automatically update all previously created instances and names imported via `from ... import ...`?"
description: "Why doesn't `importlib.reload(module)` automatically update all previously created instances and names imported via `from ... import ...`?"
track: python
