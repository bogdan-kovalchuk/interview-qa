---
id: py-modimp-0002
title: "What role does `sys.modules` play when the same module name is imported again?"
description: "What role does `sys.modules` play when the same module name is imported again?"
track: python
