---
id: py-oop-0007
title: "Why can a property usually not be shadowed by a same-named value in `instance.__dict__`?"
description: "Why can a property usually not be shadowed by a same-named value in `instance.__dict__`?"
track: python
