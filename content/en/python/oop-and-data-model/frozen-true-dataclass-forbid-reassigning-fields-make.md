---
id: py-oop-0031
title: "Why does `frozen=True` on a `@dataclass` forbid reassigning fields, but not make a nested mutable object immutable?"
description: "Why does `frozen=True` on a `@dataclass` forbid reassigning fields, but not make a nested mutable object immutable?"
track: python
