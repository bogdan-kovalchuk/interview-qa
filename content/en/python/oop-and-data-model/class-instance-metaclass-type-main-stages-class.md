---
id: py-oop-0029
title: "Why is a class an instance of the metaclass `type`, and what main stages does a class statement go through before the class object is created?"
description: "Why is a class an instance of the metaclass `type`, and what main stages does a class statement go through before the class object is created?"
track: python
