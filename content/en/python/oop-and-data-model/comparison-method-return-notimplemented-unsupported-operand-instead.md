---
id: py-oop-0023
title: "Why should a comparison method return `NotImplemented` for an unsupported operand instead of an immediate `False` or an exception?"
description: "Why should a comparison method return `NotImplemented` for an unsupported operand instead of an immediate `False` or an exception?"
track: python
