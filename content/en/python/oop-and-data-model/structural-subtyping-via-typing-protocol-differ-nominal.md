---
id: py-oop-0026
title: "How does structural subtyping via `typing.Protocol` differ from nominal inheritance via an ABC?"
description: "How does structural subtyping via `typing.Protocol` differ from nominal inheritance via an ABC?"
track: python
