---
id: py-oop-0008
title: "How does the absence of `__dict__` in a class with `__slots__` affect dynamically adding attributes?"
description: "How does the absence of `__dict__` in a class with `__slots__` affect dynamically adding attributes?"
track: python
