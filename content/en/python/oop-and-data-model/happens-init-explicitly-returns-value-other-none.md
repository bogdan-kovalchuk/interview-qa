---
id: py-oop-0003
title: "What happens if `__init__` explicitly returns a value other than `None`, and why?"
description: "What happens if `__init__` explicitly returns a value other than `None`, and why?"
track: python
