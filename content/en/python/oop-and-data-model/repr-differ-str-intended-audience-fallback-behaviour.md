---
id: py-oop-0021
title: "How does `__repr__` differ from `__str__` in intended audience and fallback behaviour?"
description: "How does `__repr__` differ from `__str__` in intended audience and fallback behaviour?"
track: python
