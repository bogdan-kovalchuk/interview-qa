---
id: py-oop-0005
title: "How does `__getattribute__` differ from `__getattr__`, and when is each one called?"
description: "How does `__getattribute__` differ from `__getattr__`, and when is each one called?"
track: python
...
sources:
  ...
  - source_id: predecessor-answer
    ...
    url: https://github.com/tavor118/pj_python_interview_questions_and_answers/blob/02d57a7a9f34fd386eb8aa5c0094fe3f3c3ba141/docs/python/class_and_object.md#L259-L301
    accessed: 2026-09-04
    kind: community
    version: null
