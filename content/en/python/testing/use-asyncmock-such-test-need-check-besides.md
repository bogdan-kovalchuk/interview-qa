---
id: py-testing-0014
title: "When should you use `AsyncMock`, and what does such a test need to check besides the call arguments?"
description: "When should you use `AsyncMock`, and what does such a test need to check besides the call arguments?"
track: python
section: testing
level: middle
type: practical
