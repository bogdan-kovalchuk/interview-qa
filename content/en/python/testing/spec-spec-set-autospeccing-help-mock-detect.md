---
id: py-testing-0012
title: "How do `spec`, `spec_set`, and autospeccing help a mock detect drift from the real interface?"
description: "How do `spec`, `spec_set`, and autospeccing help a mock detect drift from the real interface?"
track: python
section: testing
level: middle
type: mechanism
