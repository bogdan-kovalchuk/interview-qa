---
id: py-testing-0004
title: "What seams are needed so a test doesn't depend on a real network, clock, or external service?"
description: "What seams are needed so a test doesn't depend on a real network, clock, or external service?"
track: python
section: testing
level: middle
type: practical
