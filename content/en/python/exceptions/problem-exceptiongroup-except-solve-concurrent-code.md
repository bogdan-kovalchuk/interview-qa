---
id: py-excpt-0012
title: "What problem do `ExceptionGroup` and `except*` solve in concurrent code?"
description: "What problem do `ExceptionGroup` and `except*` solve in concurrent code?"
track: python
section: exceptions
level: middle
type: mechanism
