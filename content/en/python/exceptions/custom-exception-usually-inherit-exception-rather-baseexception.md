---
id: py-excpt-0011
title: "Why should a custom exception usually inherit from `Exception` rather than `BaseException`?"
description: "Why should a custom exception usually inherit from `Exception` rather than `BaseException`?"
track: python
section: exceptions
level: middle
type: mechanism
