---
id: py-excpt-0007
title: "How does implicit exception chaining differ from an explicit `raise NewError(...) from original`?"
description: "How does implicit exception chaining differ from an explicit `raise NewError(...) from original`?"
track: python
section: exceptions
level: middle
type: comparison
