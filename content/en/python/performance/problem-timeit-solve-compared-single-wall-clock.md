---
id: py-perf-0002
title: "What problem does `timeit` solve compared to a single wall-clock time measurement?"
description: "What problem does `timeit` solve compared to a single wall-clock time measurement?"
track: python
section: performance
level: middle
type: mechanism
