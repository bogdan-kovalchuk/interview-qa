---
id: py-perf-0003
title: "How can warm-up, caching, system load, and input distribution skew a microbenchmark result?"
description: "How can warm-up, caching, system load, and input distribution skew a microbenchmark result?"
track: python
section: performance
level: senior
type: pitfall
