---
id: py-perf-0015
title: "How can batching reduce per-call I/O overhead while increasing latency and memory use?"
description: "How can batching reduce per-call I/O overhead while increasing latency and memory use?"
track: python
section: performance
level: middle
type: comparison
