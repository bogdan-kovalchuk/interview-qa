---
id: py-perf-0007
title: "Why isn't Big O enough to predict latency without the input size, constants, and memory-access behaviour?"
description: "Why isn't Big O enough to predict latency without the input size, constants, and memory-access behaviour?"
track: python
section: performance
level: senior
type: pitfall
