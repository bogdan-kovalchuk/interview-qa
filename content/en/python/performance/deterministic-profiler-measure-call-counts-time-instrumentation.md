---
id: py-perf-0001
title: "How does a deterministic profiler measure call counts and time, and why must its instrumentation overhead be taken into account when interpreting results?"
description: "How does a deterministic profiler measure call counts and time, and why must its instrumentation overhead be taken into account when interpreting results?"
track: python
section: performance
level: middle
type: mechanism
