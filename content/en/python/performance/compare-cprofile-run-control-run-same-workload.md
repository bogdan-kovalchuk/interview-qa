---
id: py-perf-0004
title: "How do you compare a `cProfile` run with a control run on the same workload, to tell instrumentation overhead apart from a real bottleneck?"
description: "How do you compare a `cProfile` run with a control run on the same workload, to tell instrumentation overhead apart from a real bottleneck?"
track: python
section: performance
level: senior
type: practical
