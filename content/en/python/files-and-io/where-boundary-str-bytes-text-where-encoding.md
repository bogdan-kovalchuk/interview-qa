---
id: py-fileio-0001
title: "Where is the boundary between `str` and `bytes` in text I/O, and where should encoding and decoding happen?"
description: "Where is the boundary between `str` and `bytes` in text I/O, and where should encoding and decoding happen?"
track: python
...
sources:
  ...
  - source_id: predecessor-answer
    ...
    url: https://github.com/tavor118/pj_python_interview_questions_and_answers/blob/02d57a7a9f34fd386eb8aa5c0094fe3f3c3ba141/docs/python/files_and_io.md#L19-L28
    accessed: 2026-09-04
    kind: community
    version: null
