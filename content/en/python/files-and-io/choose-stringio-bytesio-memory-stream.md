---
id: py-fileio-0014
title: "When should you choose `StringIO`, and when `BytesIO`, for an in-memory stream?"
description: "When should you choose `StringIO`, and when `BytesIO`, for an in-memory stream?"
track: python
...
sources:
  ...
  - source_id: predecessor-answer
    ...
    url: https://github.com/tavor118/pj_python_interview_questions_and_answers/blob/02d57a7a9f34fd386eb8aa5c0094fe3f3c3ba141/docs/python/files_and_io.md#L84-L92
    accessed: 2026-09-04
    kind: community
    version: null
