---
id: py-funcs-0008
title: "When is a custom sentinel object better than `None` as a default argument in a public API?"
description: "When is a custom sentinel object better than `None` as a default argument in a public API?"
track: python
