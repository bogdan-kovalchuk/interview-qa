...
description: "TLS protects embedded telemetry and updates, but certificate storage, handshake buffers, cryptographic time, and entropy are constrained resources."
track: embedded
