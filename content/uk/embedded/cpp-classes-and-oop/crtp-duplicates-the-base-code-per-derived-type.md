...
Base-код дублюється для кожного похідного типу (окрема інстанціація шаблону).

При багатьох похідних типах і великих base-методах це роздуває ROM. Також не можна тримати різні CRTP-типи в одному масиві – кожна інстанціація є окремим типом.
