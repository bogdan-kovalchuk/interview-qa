...
Embedded-use case: стабільний driver API, прихований state machine, можливість змінити поля без перекомпіляції всіх користувачів або ламання ABI.[^embeddedinterviewlab]
