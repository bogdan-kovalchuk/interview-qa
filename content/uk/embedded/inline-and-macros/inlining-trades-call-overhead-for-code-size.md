...
Для крихітних функцій це часто зменшує код (виклик дорожчий за тіло). Для більших або часто викликаних – навпаки роздуває flash і тисне на I-cache, інколи сповільнюючи систему.
