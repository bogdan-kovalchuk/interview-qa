...
Макрос розгортається ще до компіляції, тож дебагер бачить лише inline-підставлений код у місці виклику. Повідомлення про помилку також вказує на <span class="warn">розгорнутий код, а не на рядок `#define`</span>.
