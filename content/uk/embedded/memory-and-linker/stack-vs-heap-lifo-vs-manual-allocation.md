...
**Stack** – автоматична пам'ять: локальні змінні і адреси повернення функцій.[^dou-embedded-interview] Керується компілятором/CPU за принципом LIFO. Швидкий доступ, обмежений розмір, звільнення автоматичне при виході з функції.
