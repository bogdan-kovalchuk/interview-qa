...
**ptrdiff_t** – знаковий цілочисельний тип для зберігання результату відняття двох вказівників, визначений у `<stddef.h>`. Розмір: відповідає розрядності платформи (32-bit -> 4B, 64-bit -> 8B).
