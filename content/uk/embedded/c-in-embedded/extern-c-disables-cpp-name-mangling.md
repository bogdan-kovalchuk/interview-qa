...
Це потрібно, коли C++ код викликає C-бібліотеку або C код має викликати функцію, написану на C++. Типовий header пишуть так: `#ifdef __cplusplus extern "C" { #endif` ... `#ifdef __cplusplus } #endif`. Сам код функції лишається C++ кодом, але ABI і назва символу стають C-сумісними.
