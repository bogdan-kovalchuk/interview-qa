...
### Кандидати на дублікати після завершеного імпорту

Одинадцять питань були позначені автоматично за подібністю заголовків і потребують ручного
порівняння з рештою корпусу: `emb-structs-0007`, `emb-structs-0014`, `emb-volconst-0013`,
`emb-volconst-0020`, `emb-volconst-0022`, `emb-volconst-0023`, `emb-volconst-0026`,
`emb-fnptr-0002`, `emb-align-0011`, `emb-patterns-0038`, `emb-raii-0033`. Їхній текст уже є в
`content/`; цей review не блокує збірку.
